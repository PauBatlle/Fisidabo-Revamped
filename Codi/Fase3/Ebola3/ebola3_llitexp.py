...
def ebola3exp(mu, nu, spininicial, c, k, sigma, xg, yg, vxg, vyg, length):
    ...
    #[xg, yg] = [0.8,0]
    #[vxg, vyg] = [0.05,0.05] #si el llances des d'una pos amb yg = 0, el codi canviarà una velocitat [0,0] per una que fa orbites circulars
    #spininicial = 0 # és Rw*s[0]
